class ElementStyle < ActiveRecord::Base
  attr_accessible :element_id, :height, :left, :top, :width, :z_index, :bg_color, :border_radius, :padding, :font_family, :font_size, :letter_spacing, :line_height, :img_width, :img_height, :img_left, :img_top, :background_style_g, :border_style
